...
def add_organisms_with_seed(seed, organism, data, seed_organism):
    idx = data[1] == organism
...
def map_seed_to_organisms_extended(
    ...
    for j, organism in enumerate(organisms):
        add_organisms_with_seed(seed, organism, data, organisms_with_seed)
